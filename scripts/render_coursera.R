...
output_dir <- file.path(root_dir, "docs", "coursera")
...
yaml::write_yaml(output_yaml, file.path(output_dir, "_output.yml"))
...
bookdown::render_book(
  input = paste(root_dir, "index.Rmd", sep = "/"),
  output_yaml = file.path(output_dir, "_output.yaml"),
