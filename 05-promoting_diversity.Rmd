...
```{r, fig.width= "300px", fig.align="center", fig.alt = "intersectionality", echo=FALSE, fig.cap="intersectionality"}
...
```{r, fig.height= "800px", fig.align="center", fig.alt = "microaggressions list", echo=FALSE, fig.cap="microaggressions list"}
