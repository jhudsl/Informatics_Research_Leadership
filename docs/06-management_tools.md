...
<img src="06-management_tools_files/figure-html//1OU5qeRgN_fojGbcyu2qEdwlcKpDO6BveWtYW_u1Hqd4_gd37aae88fc_0_0.png" title="Wait, what is Slack? It's a new way to communicate -faster than email and more focused than chat" alt="Wait, what is Slack? It's a new way to communicate -faster than email and more focused than chat" width="100%" />
...
<img src="06-management_tools_files/figure-html//1OU5qeRgN_fojGbcyu2qEdwlcKpDO6BveWtYW_u1Hqd4_gd37aae88fc_0_0.png" title="An image of a slack profile landing page whcih shows workspaces on the far left, then channels, then messages for a specific channel." alt="An image of a slack profile landing page whcih shows workspaces on the far left, then channels, then messages for a specific channel." width="100%" />
...
<img src="06-management_tools_files/figure-html//1OU5qeRgN_fojGbcyu2qEdwlcKpDO6BveWtYW_u1Hqd4_gd37aae88fc_0_0.png" title="An image of the options for a slack message" alt="An image of the options for a slack message" width="100%" />
...
<img src="06-management_tools_files/figure-html//1OU5qeRgN_fojGbcyu2qEdwlcKpDO6BveWtYW_u1Hqd4_gd37aae88fc_0_0.png" title="This image shows the option to pin a message in a channel." alt="This image shows the option to pin a message in a channel." width="100%" />
...
<img src="06-management_tools_files/figure-html//1OU5qeRgN_fojGbcyu2qEdwlcKpDO6BveWtYW_u1Hqd4_gd37aae88fc_0_0.png" title="An example of a slack message with code which is displayed differently as it is in red font witha gray background" alt="An example of a slack message with code which is displayed differently as it is in red font witha gray background" width="100%" />
...
<img src="06-management_tools_files/figure-html//1OU5qeRgN_fojGbcyu2qEdwlcKpDO6BveWtYW_u1Hqd4_gd37aae88fc_0_0.png" title="An image of the options for a slack message" alt="An image of the options for a slack message" width="480" />


avocado add to slides
![](images/reminder_copy.png)

<img src="06-management_tools_files/figure-html//1OU5qeRgN_fojGbcyu2qEdwlcKpDO6BveWtYW_u1Hqd4_gd37aae88fc_0_0.png" title="An image of right clicking on a slack message to allow setting a reminder of the message for either in 20 minutes, 1 hour, 3 hours, tomorrow, next week or custom." alt="An image of right clicking on a slack message to allow setting a reminder of the message for either in 20 minutes, 1 hour, 3 hours, tomorrow, next week or custom." width="100%" />
