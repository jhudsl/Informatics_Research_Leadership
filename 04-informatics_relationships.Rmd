...
```{r, fig.alt=" Learning Objectives: 1) How to mitigate challenges for collaborating on multidisciplinary informatics projects 2) How to mitigate challenges for employing informatics experts 3) How to best support mentees in cross disciplinary teams 4) How to support a diverse lab team", out.width = "100%", echo = FALSE}
...
```{r, fig.alt=" Benefits of collboration are: shared cost, shared expertise, shared burden, shared reliability, and shared credibility", out.width = "100%", echo = FALSE}
...
Is this repeated
```{r, fig.alt=" Sally, the super supportive leader thinks to herself: He is the best! Meanwhile, Harry the helpful collaborator says: Now that I understand the Biology better - thanks to you!- I think I know a better method", out.width = "100%", echo = FALSE}
...
```{r, fig.alt=" avocado", out.width = "100%", echo = FALSE}
